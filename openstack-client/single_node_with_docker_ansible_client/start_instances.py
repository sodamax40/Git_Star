...
flavor = "ssc.medium"
private_net = "UPPMAX 2023/1-2 Internal IPv4 Network"
...
instance_prod = nova.servers.create(name="prod_server_with_docker_group2_"+str(identifier), image=image,
                                    flavor=flavor, key_name="", userdata=userdata_prod, nics=nics, security_groups=secgroups)
instance_dev = nova.servers.create(name="dev_server_group2_"+str(identifier), image=image,
                                   flavor=flavor, key_name="", userdata=userdata_dev, nics=nics, security_groups=secgroups)
instance_para = nova.servers.create(name="para_server_group2_"+str(identifier), image=image,
                                    flavor=flavor, key_name="", userdata=userdata_para, nics=nics, security_groups=secgroups)
...
print("Instance: " + instance_para.name + " is in " +
      inst_status_para + " state" + " ip address: " + ip_address_para)
